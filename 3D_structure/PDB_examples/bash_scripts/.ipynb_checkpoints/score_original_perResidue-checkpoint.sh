...
for folder in "${folders[@]}"; do
    ...
    cd "$folder"
    af="ranked_0.pdb"
    score_perRes="ranked_0_perRes.sc"
    /scicore/home/zavolan/zhu0006/3D_structure/Rosetta/rosetta_bin_linux_2021.16.61629_bundle/main/source/bin/per_residue_energies.static.linuxgccrelease -in:file:s "$af" -out:file:silent "$score_perRes"
    cd ..
done
